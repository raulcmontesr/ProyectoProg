...
namespace WebFacturaMvc.Reportes
{
    public partial class frmReporteFactura : System.Web.UI.Page
    {
        ...
        {           
            con = new SqlConnection("Data Source=JAHUMADA;Initial Catalog=ventas;Integrated Security=True");
            if (!IsPostBack)
            {
                renderReport();
        ...
        public DataTable cargar(string codigoventa)
        {
            ...
            using (SqlConnection cn=new SqlConnection("Data Source=JAHUMADA;Initial Catalog=ventas;Integrated Security=True"))
            {
